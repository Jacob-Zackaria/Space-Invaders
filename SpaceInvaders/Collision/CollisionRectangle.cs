...
{
    public class CollisionRectangle : Azul.Rect
    {
        ...
        public CollisionRectangle(CollisionRectangle pRect)
            : base(pRect)
        {
        }
        ...
        static public bool Intersect(CollisionRectangle ColRectA, CollisionRectangle ColRectB)
        {
            bool status = false;

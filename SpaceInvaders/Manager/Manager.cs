...
namespace SpaceInvaders
{
    public abstract class Manager
    {
        ...
        protected DLink BaseAdd()
        {
            ...
            DLink deletedData = Manager.DeleteAtFront(ref this._pReserved);
            ...
            Manager.AddAtFront(ref this._pActive, deletedData);           
        ...
        private void AddReservedList(int newReserveSize)
        {
            ...
            while (i++ < newReserveSize)
            {
                ...
                Manager.AddAtFront(ref this._pReserved, newData);  
            }
        ...
        protected void BaseDelete(DLink pDataToDelete)
        {
            ...
            Manager.DeleteByNode(ref this._pActive, pDataToDelete);
            ...
            Manager.AddAtFront(ref this._pReserved, pDataToDelete);

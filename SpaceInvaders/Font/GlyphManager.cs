...
namespace SpaceInvaders
{
    ...
    class GlyphManager : GlyphMan_MLink
    {
        ...
        //----------------------------------------------------------------------
        public static void NewGlyph(int reserveNum = 3, int reserveGrow = 1)
        {
        ...
        {
            GlyphManager pMan = GlyphManager.GetPrivateInstance();
        ...
        // Private methods
        //----------------------------------------------------------------------
        private static GlyphManager GetPrivateInstance()
        {

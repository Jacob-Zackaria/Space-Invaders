...
{
    abstract public class GameSprite_Base : BaseSprite
    {
    ...
    public class GameSprite : GameSprite_Base
    {
        ...
        : base()
        {
            ...
            this.pImage = ImageManager.Search(Image.Name.Default);
        ...
        public void SetSprite(Name newName, Image pNewImage, float x, float y, float width, float height, Azul.Color pColor)
        {
            ...
            if (pColor == null)
            {
                Debug.Assert(GameSprite.pTmpColor != null);
                GameSprite.pTmpColor.Set(1, 1, 1);

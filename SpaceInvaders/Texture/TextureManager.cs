...
{
    abstract public class TextureMan_Link : Manager
    {
        public Texture_Link poActive;
        public Texture_Link poReserve;
    }
    public class TextureManager : TextureMan_Link
    {
        //---------------------------------------------------------------------------------------------------------
        //Static Data.
        //---------------------------------------------------------------------------------------------------------
        private static TextureManager _pInstance = null;
        ...
        //Private Constructor.
        //---------------------------------------------------------------------------------------------------------
        private TextureManager(int initialReserveSize = 2, int newGrowthSize = 2)
        :   base()     //Delegate.
        {
        ...
        public static void NewTexture(int initialReserveSize = 2, int newGrowthSize = 2)
        {
            ...
            if (_pInstance == null)
            {
                ...
                _pInstance = new TextureManager(initialReserveSize, newGrowthSize);
            }
        ...
        public static Texture Add(Texture.Name newName, string pTextureName)
        {
            ...
            TextureManager pMan = TextureManager.GetPrivateInstance();
        ...
        //PRIVATE
        //--------------------------------------------------------------------------------
        private static TextureManager GetPrivateInstance()
        {

...
{
    abstract public class SoundMan_Link : Manager
    {
        public SoundSource_Link poActive;
        public SoundSource_Link poReserve;
    }
    public class SoundManager : SoundMan_Link
    {
        //---------------------------------------------------------------------------------------------------------
        //Static Data.
        //---------------------------------------------------------------------------------------------------------
        private static SoundManager _pInstance = null;
        ...
        //Private Constructor.
        //---------------------------------------------------------------------------------------------------------
        private SoundManager(int initialReserveSize = 2, int newGrowthSize = 2)
        : base()     //Delegate.
        {
        ...
        public static void NewSound(int initialReserveSize = 2, int newGrowthSize = 2)
        {
            ...
            if (_pInstance == null)
            {
                ...
                _pInstance = new SoundManager(initialReserveSize, newGrowthSize);
            }
        }
        ...
        //PRIVATE
        //--------------------------------------------------------------------------------
        private static SoundManager GetPrivateInstance()
        {

...
namespace SpaceInvaders
{
    ...
    public class GameObjectManager : GameObjectMan_MLink
    {
        ...
        // Static Data.
        //----------------------------------------------------------------------
        private static GameObjectManager _pInstance = null;
        ...
        //Constructor.
        //----------------------------------------------------------------------
        private GameObjectManager(int initialReserveSize = 2, int newGrowthSize = 2)
        :   base()     //Delegate.
        {
            ...
            this.pNullGameObject = new NullGameObject();    //Create new null object.
        ...
        //---------------------------------------------------------------------------------------------------------
        public static void NewGameObject(int initialReserveSize = 2, int newGrowthSize = 2)
        {
            ...
            if (_pInstance == null)
            {
                ...
                _pInstance = new GameObjectManager(initialReserveSize, newGrowthSize);
            }
        }
        ...
        public static void Destroy()
        {
            ...
            GameObjectManager pMan = GameObjectManager.GetPrivateInstance();
        ...
        public static void UpdateScore()
        {
            ...
            //Set font message.
            pMan.p1Font = FontManager.Search(Font.Name.Score1);
            pMan.pHighFont = FontManager.Search(Font.Name.HighScore);
        ...
        public static bool DecreaseLife(bool val = false)
        {
            ...
            //Set font message.
            pMan.pLifeFont = FontManager.Search(Font.Name.Life);
            pMan.livesLeft--;
        ...
        //PRIVATE
        //--------------------------------------------------------------------------------
        private static GameObjectManager GetPrivateInstance()
        {

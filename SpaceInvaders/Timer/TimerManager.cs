...
namespace SpaceInvaders
{
    ...
    public class TimerManager : TimerMan_MLink
    {
        //---------------------------------------------------------------------------------------------------------
        //Static Data.
        //---------------------------------------------------------------------------------------------------------
        private static TimerManager _pInstance = null;
        ...
        //Private Constructor.
        //---------------------------------------------------------------------------------------------------------
        private TimerManager(int initialReserveSize = 2, int newGrowthSize = 2)
        : base()       //Delegate.
        {
        ...
        //---------------------------------------------------------------------------------------------------------
        public static void NewTimer(int initialReserveSize = 2, int newGrowthSize = 2)
        {
            ...
            if (_pInstance == null)
            {
                ...
                _pInstance = new TimerManager(initialReserveSize, newGrowthSize);
            }
        }
        ...
        public static TimeEvent Add(TimeEvent.Name timeName, Command pCommand, float deltaTime)
        {
            ...
            TimerManager pMan = TimerManager.GetPrivateInstance();
        ...
        //PRIVATE
        //--------------------------------------------------------------------------------
        private static TimerManager GetPrivateInstance()
        {
